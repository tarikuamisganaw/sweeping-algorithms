...
impl<V: Clone + Send + Sync> LineListNode<V> {
    ...
    #[inline]
    fn set_payload_abstract<const IS_CHILD: bool>(&mut self, key: &[u8], mut payload: ValOrChildUnion<V>) -> Result<(Option<ValOrChild<V>>, bool), TrieNodeODRc<V>> where V: Clone {
